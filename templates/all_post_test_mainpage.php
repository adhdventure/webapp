<?php
/**
 * TEMPLATE: MAINPAGE POST TEST
 **/

// Check user role and display the template name for administrators only
    ...
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card position-relative">
          <div class="card-body">
            <h4 style="text-align:center;">Post Test</h4>
            <div>
              <button type="button" class="btn btn-primary" onclick="location.href='https://www.adhdadventure.online/adding-post-test/'">
            ...
            <br>
            <table id="activesf" class="table-hover table-bordered" style="width:100%; text-align: center">
              <thead>
                <tr>
                  <th>IDK</th>
                  <th>PHASE</th>
              ...
              <tbody>
                 ...
                 */
                $counters = 0;
                $gallnewactv = $wpdb->get_results("SELECT * FROM `post_test_answer`");
                foreach ($gallnewactv as $key => $gcvalue) {
                ?>
                  <tr>
                    <td><?php echo ++$counters ?></td>
                    <td><?php echo $gcvalue->phase_number; ?></td>
                    <td><?php echo $gcvalue->quiz_number; ?></td>
                    <td>
                      <div>
                        <?php echo htmlspecialchars_decode(stripslashes($gcvalue->question)); ?>
                      </div>
                    </td>
                    <td><?php echo $gcvalue->correct_answer; ?></td>
                    <td>
                      <form method="post">
...
if (isset($_POST['deledata'])) {
  ...
  $deldata = $wpdb->delete("post_test_answer", array('idkey' => $gikeys), array('%d'));
  if ($deldata) {
