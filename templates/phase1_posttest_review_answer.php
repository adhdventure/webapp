...
<html lang="en">
  ...
  <body onload="onloadfunct()">
    ...
    <div class="container">
      ...
      <h2 style="text-align:center;color:#fff; background-color:#ffc107; width:50%; margin:0 auto">POST TEST REVIEW</h2>
              ...
              <div class="row">
                <div class="col d-flex justify-content-center" style="margin-top:2%">
                      <?php
                        ...
                        $gacontentssid = $wpdb->get_results(" SELECT * FROM all_phases_contents WHERE page ='POST TEST REVIEW' AND  phase = 'PHASE 1' ");
          ...
          foreach ($gifpagevhassc as $key => $fsgvalue) {
            $idkrecys = $fsgvalue->recexist;
              ...
              if(  $idkrecys > 0 ){
                ...
                $location ="https://www.adhdadventure.online/phase-1-post-test-correct/";
