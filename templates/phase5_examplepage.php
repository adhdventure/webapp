  ...
  <body onload="onloadfunct()">
    ...
    <div class="container">
      <img onclick="history.back()"  src="http://www.adhdadventure.online/wp-content/uploads/2023/04/Back-Icon.png" class="imgbckbtn">
        ...
        <br>
        <br>
          <h2 style="text-align:center;color:#fff; background-color:#ffc107; width:65%; margin:0 auto">EXAMPLE</h2>

          <div class="row">
            <div class="col d-flex justify-content-center" style="margin-top:2%">
                  <?php

                    $gacontentssid = $wpdb->get_results(" SELECT * FROM all_phases_contents WHERE page ='EXAMPLE' AND  phase = 'PHASE 5' ");
          ...
          foreach ($gifpagevhassc as $key => $fsgvalue) {
            $idkrecys = $fsgvalue->recexist;
              ...
              if(  $idkrecys > 0 ){
                ...
                $location = "https://www.adhdadventure.online/phase-5-learning-style/";
