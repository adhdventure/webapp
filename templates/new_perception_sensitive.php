            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card position-relative">
                <div class="card-body">
                  ...
                  <h4 style="text-align:center"> New Perception Sensitive</h4>
                 ...
                 <?php
...

                  {
                         ...
                         $makeanswcaps = strtoupper($answer);
                          ...
                          $insertdbs = $wpdb->insert("perception_sensitive",
                          ...
                          if($insertdbs){
                              ...
                              $location = "https://www.adhdadventure.online/perception-sensitive/";
