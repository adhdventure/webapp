  ...
  <body onload="onloadfunct()">
    ...
    <div class="container">
      <img onclick="history.back()"  src="http://www.adhdadventure.online/wp-content/uploads/2023/04/Back-Icon.png" class="imgbckbtn">
        ...
        <br>
        <div class="row">
          <div class="col d-flex justify-content-center" style="margin-top:2%;padding:5% !important;">
                <?php

                  $gacontentssid = $wpdb->get_results(" SELECT * FROM all_phases_contents WHERE page ='YOUTUBE' AND  phase = 'PHASE 1' ");
