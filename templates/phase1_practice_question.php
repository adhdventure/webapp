        ...
        <div class="row">
          <div class="col d-flex justify-content-center" style="margin-top:2%">
                <?php
                  ...
                  $gacontentssid = $wpdb->get_results(" SELECT * FROM all_phases_contents WHERE page ='PRACTICE TEST' AND  phase = 'PHASE 1' ");
            ...
            $idkrecys = $fsgvalue->recexist;
              ...
              $points = 1;
                ...
                $inserttoscore = $wpdb->insert("adhd_learning_points_system",
                  ...
                  $location ="https://www.adhdadventure.online/phase-1-post-test/";
