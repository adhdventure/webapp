            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card position-relative">
                <div class="card-body">
                    ...
                    <h4 style="text-align:center;">Perception Intuitive</h4>

                      <div >
                          <button type="button" class="btn btn-primary" onclick="location.href='https://www.adhdadventure.online/new-perception-intuitive/'">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                          </svg>
                            New Perception Intuitive</button>
                      ...
                      <table id="activesf" class="table-hover table-bordered" style="width:100%;">
                        ...
                        <tbody>
                          <?php
                            ...
                            **/
                            $counters = 0;
                            $gallnewactv = $wpdb->get_results("SELECT * FROM `perception_sensitive`");
