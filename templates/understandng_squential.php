<?php
/**
 * TEMPLATE: UNDERSTAND AND SEQUENTIAL
 */
?>
...
<?php
// Adding default design and calling it
    ...
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card position-relative">
          <div class="card-body">
            <h4 style="text-align:center;">Understanding Sequential</h4>
            <div>
              <button type="button" class="btn btn-primary" onclick="location.href='https://www.adhdadventure.online/new-understanding-sequential/'">
            ...
            <table id="activesf" class="table-hover table-bordered" style="width:100%;">
              ...
              <tbody>
                 ...
                 */
                $counters = 0;
                $gallnewactv = $wpdb->get_results("SELECT * FROM `understanding_sequential`");
