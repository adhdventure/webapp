...
<html lang="en">
  ...
  <body onload="onloadfunct()">
    ...
    <div class="container">
        ...
        <div class="col d-flex justify-content-center" style="margin-top:2%">
            ...
            <table>
              <tr>
                ...
                <td>
                  <img style="width:50%;"  src="http://www.adhdadventure.online/wp-content/uploads/2023/04/opponent-1.png" alt="">
      ...
      <div class="row" >
        <div class="col">
            <img src="http://www.adhdadventure.online/wp-content/uploads/2023/04/question-panel.png" style="width:100%; height:50vh" alt="">

              <h1 class="texttops" style="margin-top:-60%; text-align:center; text-transform: uppercase; font-size:2rem;word-wrap: break-word; padding:10%;">
                  <div class="innerquest">
                  <?php
                            ...
                            **/
                            ...
                            $dpostphase1 = $wpdb->get_results("SELECT * FROM `post_test_answer` WHERE phase_number='PHASE 1' AND quiz_number = '$affvalue' ");

                            foreach ($dpostphase1 as $key => $vsdfalue) {


                                $quiznumbs = $vsdfalue->quiz_number;




                                            $questions = $vsdfalue->question;
                                            echo $questions;
        ...
        <div class="col align-middle">
          ...
          <table style="margin:0 auto">
            ...
            <tr>
             <td>
                <input type="hidden" id="usaccount" value="<?php echo  $currenuser;?>">
                <input type="hidden" id="stquiznumbs" value="<?php echo  $quiznumbs;?>">

               <button onclick="btn1('<?php echo $lettera ?>')"  style="font-size: 2rem;width:150px" type="button" name="button1" class="btn btn-success" ><?php echo $lettera ?> </button>

             </td>
             <td> <button  onclick="btn2('<?php echo $letterb ?>')" style="font-size: 2rem;width:150px" type="button" name="button2" class="btn btn-info" ><?php echo $letterb ?></button></td>
           </tr>
           <tr>
                  <td>   <button onclick="btn3('<?php echo $letterc ?>')" style="font-size: 2rem;width:150px" type="button" name="button3" class="btn btn-warning"><?php echo $letterc ?></button></td>
                  <td>  <button onclick="btn4('<?php echo $letterd ?>')" style="font-size: 2rem;width:150px" type="button" name="button4" class="btn btn-danger" ><?php echo $letterd ?></button></td>
            </tr>
   ...
   <script type="text/javascript">
    ...
    function btn1(correctsans){
      ...
      if (result.isConfirmed) {
        ...
        let correctsanss = correctsans;

          $.post("https://www.adhdadventure.online/adhd-functions/", {

              correctsanss:correctsanss
                        ...
                        if(gdatas > 0 || gdatas > '0'){
                          ...
                          Swal.fire(
                            ...
                            'success'
                              ...
                              let gcorrectsanss = correctsanss;
                              let stquiznumbs = $("#stquiznumbs").val();
                              let correctans = 1;


                            $.post("https://www.adhdadventure.online/adhd-functions/", {

                                  gcorrectsanss:gcorrectsanss,
                                  stquiznumbs:stquiznumbs,
                          ...
                          let imgsrlink = 'http://www.adhdadventure.online/wp-content/uploads/2023/05/Sorry-background.png';
...
<?php
  ...
  **/
  ...
  $gstudnentsrecs = $wpdb->get_results("SELECT COUNT(phase_number) AS phase_number FROM `post_test_student_scores`WHERE phase_number ='PHASE 1' AND student_id ='$current_user->user_login'");
  foreach ($gstudnentsrecs as $key => $vdsfalue) {
      ...
      if($gikdsfd > 4 ){
                ...
                $totalscrrc = 0;
                $gstudnentsrecsa = $wpdb->get_results("SELECT * FROM `post_test_student_scores`WHERE phase_number ='PHASE 1' AND student_id ='$current_user->user_login'");
