  ...
  <body onload="onloadfunct()">
    ...
    <div class="container">
      ...
      <img onclick="location.href='https://www.adhdadventure.online/audio-settings/'" src="http://www.adhdadventure.online/wp-content/uploads/2023/04/Settings-Icon.png" class="imgmenu">
          ...
          <br>
        <br>
          <h2 style="text-align:center;color:#fff; background-color:#ffc107; width:50%; margin:0 auto">Demo / Instruction</h2>
        <div class="row">

        <div class="col d-flex justify-content-center" style="margin-top:2%; width:90% !important">
              <?php

                $gacontentssid = $wpdb->get_results(" SELECT * FROM all_phases_contents WHERE page ='SYSTEM INSTUCTIONAL VIDEO' AND  phase = 'PHASE 1' ");
        ...
        <form  method="post">
            ...
            <input type="hidden" name="pagevisit" value="demo_instruction">
            ...
            $idkrecys = $fsgvalue->recexist;
              ...
              $points = 1;
                ...
                $inserttoscore = $wpdb->insert("adhd_learning_points_system",
                  ...
                  $location ="https://www.adhdadventure.online/begin/";
