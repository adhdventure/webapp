            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card position-relative">
                <div class="card-body">
                  ...
                  <h4 style="text-align:center"> New Active Process Dimension</h4>
                 ...
                 <?php
...

                  {
                         ...
                         $makeanswcaps = strtoupper($answer);
                          ...
                          $insertdbs = $wpdb->insert("active_process_dimens",
                          ...
                          if($insertdbs){
                              ...
                              $location = "https://www.adhdadventure.online/active-processing-dimension/";
