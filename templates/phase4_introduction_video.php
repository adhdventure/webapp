  ...
  <body onload="onloadfunct()">
    ...
    <div class="container">
      <img onclick="history.back()"  src="http://www.adhdadventure.online/wp-content/uploads/2023/04/Back-Icon.png" class="imgbckbtn">
        <br>
        <br>
          <h2 style="text-align:center;color:#fff; background-color:#ffc107; width:50%; margin:0 auto">Introduction Video</h2>
        <div class="row">

        <div class="col d-flex justify-content-center" style="margin-top:2%; width:80% !important">


          <?php

            $gacontentssid = $wpdb->get_results("SELECT * FROM all_phases_contents WHERE page ='PHASES INTRO VIDEO' AND phase = 'PHASE 4' ");
              ...
              $points = 1;
                ...
                $inserttoscore = $wpdb->insert("adhd_learning_points_system",
                  array(
                    ...
                    $location = "https://www.adhdadventure.online/phase-4-development-page/";
