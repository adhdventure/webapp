    ...
    <div class="container">
      ...
      <img onclick="location.href='https://www.adhdadventure.online/indx/'" src="http://www.adhdadventure.online/wp-content/uploads/2023/04/Settings-Icon.png" class="imgmenu">
        ...
        <div class="col d-flex justify-content-center" style="margin-top:2%">
          ...
          <iframe src="https://onedrive.live.com/embed?cid=0E0E69E64BFAABD6&resid=E0E69E64BFAABD6%21168&authkey=ADWz7bqTNWgiUyU&em=2" width="100%" height="500" frameborder="0" scrolling="no"></iframe>
           <br>
          <br>
        ...
        <!-- <button onclick="location.href='#'" id="skipbtn" style="float:right; border-radius: 25px 25px; font-size:2rem; display:none;"  class="btn btn-warning" type="button" name="button">
            NEXT
        </button> -->
          ...
          foreach ($gifpagevhassc as $key => $fsgvalue) {
            $idkrecys = $fsgvalue->recexist;
              ...
              if(  $idkrecys > 0 ){
                ...
                $location ="https://www.adhdadventure.online/phase-3-refresher/";
