            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card position-relative">
                <div class="card-body">
                  ...
                  <h4 style="text-align:center"> New Understanding Sequential</h4>
                 ...
                 <?php
...

                  {
                         ...
                         $makeanswcaps = strtoupper($answer);
                          ...
                          $insertdbs = $wpdb->insert("understanding_sequential",
                          ...
                          if($insertdbs){
                              ...
                              $location = "https://www.adhdadventure.online/understanding-sequential/";
