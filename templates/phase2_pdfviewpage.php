  ...
  <body onload="onloadfunct()">
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col d-flex justify-content-center" style="margin-top:2%">
                <?php
                  ...
                  $gacontentssid = $wpdb->get_results(" SELECT * FROM all_phases_contents WHERE page ='PDF' AND  phase = 'PHASE 2' ");
      ...
      <br>
        ...
        <button onclick="location.href='https://www.adhdadventure.online/phase-1-practice-questions/'" id="skipbtn" style="float:right; border-radius: 25px 25px; font-size:2rem; display:none;"  class="btn btn-warning" type="button" name="button">
            PRACTICE TEST
        </button>

        <form  method="post">

            <input type="hidden" name="pagevisit" value="phase1_pdf_text">
