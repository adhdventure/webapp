<?php
 ...
 /**
 ** TEMPLATE: INPUT AND VERBAL LEARNING DIMENSION
 **/
?>
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card position-relative">
                <div class="card-body">
                    ...
                    <h4 style="text-align:center;">Input Verbal</h4>

                      <div >
                          <button type="button" class="btn btn-primary" onclick="location.href='https://www.adhdadventure.online/new-input-verbal/'">
                      ...
                      <table id="activesf" class="table-hover table-bordered" style="width:100%;">
                        ...
                        <tbody>
                          <?php
                            ...
                            **/
                            $counters = 0;
                            $gallnewactv = $wpdb->get_results("SELECT * FROM `input_verbal`");
