        ...
        <div class="row">
          <div class="col d-flex justify-content-center" style="margin-top:2%">
                <?php
                  ...
                  $gacontentssid = $wpdb->get_results(" SELECT * FROM all_phases_contents WHERE page ='REFRESHER' AND  phase = 'PHASE 4' ");
          ...
          foreach ($gifpagevhassc as $key => $fsgvalue) {
            $idkrecys = $fsgvalue->recexist;
              ...
              if(  $idkrecys > 0 ){
                ...
                $location ="https://www.adhdadventure.online/phase-5-guide/";
