  ...
  <body onload="onloadfunct()">
    ...
    <div class="container">
      <img onclick="history.back()"  src="http://www.adhdadventure.online/wp-content/uploads/2023/04/Back-Icon.png" class="imgbckbtn">
        ...
        <div class="row">
          <div class="col d-flex justify-content-center" style="margin-top:2%">
                <?php
                  ...
                  $gacontentssid = $wpdb->get_results(" SELECT * FROM all_phases_contents WHERE page ='YOUTUBE' AND  phase = 'PHASE 2' ");
        ...
        <!-- <button onclick="location.href='https://www.adhdadventure.online/phase-2-practice-question/'" id="skipbtn" style="float:right; border-radius: 25px 25px; font-size:2rem; display:none;"  class="btn btn-warning" type="button" name="button">
            PRACTICE TEST
        </button> -->

        <form  method="post">

            <input type="hidden" name="pagevisit" value="phase1_youtube">
          ...
          foreach ($gifpagevhassc as $key => $fsgvalue) {
            $idkrecys = $fsgvalue->recexist;
              ...
              if(  $idkrecys > 0 ){
                ...
                $location ="https://www.adhdadventure.online/phase-2-practice-question/";
          ...
          foreach ($gifpagevhassc as $key => $fsgvalue) {
            $idkrecys = $fsgvalue->recexist;
              ...
              if(  $idkrecys > 0 ){
                ...
                $location ="https://www.adhdadventure.online/phase-1-practice-questions/";
                echo  wp_redirect( $location);
