 ...
 * This template is used for the ADventure Dashboard.
 **/
...
<head>
  ...
  <!-- Include CSS files for page-specific plugins -->
  ...
  <!-- Include DataTables CSS and other related CSS files -->
      ...
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card position-relative">
          <div class="card-body">
            ...
            <h4 style="text-align:center;">Understanding Global</h4>

            <div>
              <button type="button" class="btn btn-primary" onclick="location.href='https://www.adhdadventure.online/new-understanding-global/'">
            ...
            <table id="activesf" class="table-hover table-bordered" style="width:100%;">
              ...
              <tbody>
                 ...
                 * Fetch all the entries from the `understanding_global` table
                 **/
                $counters = 0;
                $gallnewactv = $wpdb->get_results("SELECT * FROM `understanding_global`");
  ...
  <footer class="footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
      <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">
        Copyright © 2023.
        <a href="https://www.adhdadventure.online/" target="_blank">ADventure</a>
        All rights reserved.
      </span>
...
<!-- inject:js -->
<!-- Include custom JS for the template -->
...
<!-- Include custom JS for the page -->
<script src="<?php echo plugin_dir_url( __FILE__ ) . '/dashboard/js/dashboard.js';?>"></script>
<script src="<?php echo plugin_dir_url( __FILE__ ) . '/dashboard/js/Chart.roundedBarCharts.js';?>"></script>
